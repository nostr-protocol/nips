...
Marketplace clients that need profile-specific relay filters MAY use the
[NIP-99 Marketplace Listing Extension](XX.md) to define promoted tags whose
meaning is scoped by a listing's `t` tag.
