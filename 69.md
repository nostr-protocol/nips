...
```json
{
  ...
  "tags": [
    ["d", "labels-<eventid of event being labeled>"],
    ["e", "<eventid of event being labeled>", "<recommended relay URL>", "report"],
    ["p", "<pubkey of event being labeled>"],
    [ "l", "MOD>warn-public" ],
...
Clients apps MAY additionally choose to support "Super Moderators" which is when the publicly visible people on the moderator list of a user's moderator are also used. Super moderators will be saved with a `d` tag of "moderators/super".
