...
async window.nostr.nip44.getKey(pubkey): string // takes third party pubkey and returns shared secret key as specified in nip-44
async window.nostr.nip44.encrypt(pubkey, plaintext): string // takes third party pubkey, plain text and returns ciphertext as specified in nip-44
async window.nostr.nip44.decrypt(pubkey, ciphertext): string // takes third party pubkey, ciphertext and returns plain text as specified in nip-44
```
