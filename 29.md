...
- `open` indicates that users can expect join requests to be honored, while `closed` indicates that join requests are ignored. If omitted, groups should be considered `open` by default.
