...
- `permissive` indicates that the group can be _written to_ by anyone, while `restricted` indicates that only members can write. If omitted, groups should be considered `permissive` by default.
