...
Relays expose a websocket endpoint to which clients can connect. Clients should not open more than one websocket to each relay. One channel can support an unlimited number of subscriptions, so clients should do that.
