...
Clients SHOULD randomize `created_at` in up to two days in the past in the gift wrap to make sure that grouping by `created_at` doesn't reveal any metadata.
