...
`kind:13` encrypts, signs and seals the message. It wraps the **unsigned** `kind:14` event and is signed with the sender's regular key. 
...
A gift wrap event (`kind:1059`) wraps `kind:13` to hide the author from public view. The only public information in this event is the receiver's key. 
...
```json
{
   ...
   "tags":[
      [
         "p",
         "44900586091b284416a0c001f677f9c49f7639a55c3f1e2ec130a8e1a7998e1b"
      ]
   ],
