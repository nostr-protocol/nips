...
`kind:14` is defined as a chat message. It is designed to be a Rumor in [NIP-59](59.md) and thus MUST never be signed. If it is signed, the message becomes **fully public**. This event kind requires the rest of this protocol to make it private.  
