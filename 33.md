...
| `mime_type` | yes      | MIME type of the file before encryption                           |
| `size`      | yes      | Original unencrypted file size in bytes                           |
| `sha256`    | yes      | Hex SHA-256 of the **encrypted** file bytes                       |
| `key`       | yes      | Hex-encoded 32-byte AES-256-GCM key, MUST be randomly generated per event |
