...
And receives two follow lists, one from `21df6d143fb96c2ec9d63726bf9edc7121df6d143fb96c2ec9d63726bf9edc71` that says

```json
[
  ["p", "a8bb3d884d5d90b413d9891fe4c4e46da8bb3d884d5d90b413d9891fe4c4e46d", "", "david"]
]
```

and another from `a8bb3d884d5d90b413d9891fe4c4e46da8bb3d884d5d90b413d9891fe4c4e46d` that says
...
When the user sees `a8bb3d884d5d90b413d9891fe4c4e46da8bb3d884d5d90b413d9891fe4c4e46d` the client can show `~erin/david` instead;
When the user sees `f57f54057d2a7af0efecc8b0b66f5708f57f54057d2a7af0efecc8b0b66f5708` the client can show `~erin/david/frank` instead.

Name resolution can work on the other direction, too. If a user wants to refer to `f57f54057d2a7af0efecc8b0b66f5708f57f54057d2a7af0efecc8b0b66f5708` but doesn't know his key he can instead write `~erin/david/frank` and the client may look into the follow lists of `erin` for `david` and in that for `frank`.

This can also be mixed with [NIP-05](05.md), if the first entry in the namespace has not a petname, but a DNS-based name, such as `erin@names.com`, one can do `~erin@names.com/david/frank` and get the public key `f57f54057d2a7af0efecc8b0b66f5708f57f54057d2a7af0efecc8b0b66f5708` back.
