...
Service providers MUST use different service keys to for distinct algorithms, including a key per user when the algorithm is personalized to that user's point of view or settings.
