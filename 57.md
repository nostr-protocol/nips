...
- `anon` is an empty string. If present the client should generate a new keypair and sign the event with the newly generated private key.
...
9. There MUST be 0 or 1 `anon` tag.
