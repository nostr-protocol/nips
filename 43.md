...
The two NIP-44 encryptions when wrapping and sealing use the random author's privkey,
the recipient's pubkey and no salt suffix as arguments to generate the conversation key.
