...
- `params` is an optional [JSON schema](https://json-schema.org/) describing non-standard parameters that the service accepts. The top-level schema SHOULD be of type `object`.
