...
| Name | Domain | Upload Cost | NIP-60 Fee | File Retention Policy |
| ---- | ------ | ----------- | ---------- | --------------------- |
| -    | -      | -           | -          | ❌️                    |
...
The server may alter `zap` tags to add its revenue share fee. For example:
  ...
  nip60: {
    ...
    unsigned_event: {
      ...
      "tags": [
        ...
        ["url", "https://server.domain/nip96/719171db19525d9d08dd69cb716a18158a249b7b3b3ec4bbdec5698dca104b7b.json"],
        ["x", "719171db19525d9d08dd69cb716a18158a249b7b3b3ec4bbdec5698dca104b7b"],
        ["m", "nostr/30023"],
        ["preview", "<preview url/text>", "<MIME type>"],
        // if it is an image and both the preview and blurhash tag are absent, the server may add a blurhash tag
...
```js
{
  ...
  "tags": [
    [
        "u",
        "https://server.domain/nip96/719171db19525d9d08dd69cb716a18158a249b7b3b3ec4bbdec5698dca104b7b.json" // with or without the extension
    ],
    [
        "method",
        "GET"
