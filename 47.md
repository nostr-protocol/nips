...
Description: Requests payment for multiple offers.

Request:
```jsonc
{
    "method": "multi_pay_offefr",
    "params": {
        "offers": [
          {"id":"4da52c32a1", "offer": "lno1pgx...", "amount": 123, "payer_note": "string"}, // bolt12 offer, amount in msats and payer_note, amount is optional if the bolt12 offer contains an amount, payer_note is optional
          {"id":"3da52c32a1", "invoice": "lno50n1..."},
        ],
    }
}
```
...
Description: Decode any offer and provide the main offer fields.
...
```jsonc
{
    ...
    "result": {
            ...
            "methods": ["pay_invoice", "get_balance", "make_invoice", "lookup_invoice", "list_transactions", "pay_offer", "make_offer", "enable_offer", "disable_offer", "list_offers", "get_offer_info", "get_info"], // list of supported methods for this connection
