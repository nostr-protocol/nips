...
```jsonc
{
    ...
    "result": {
            ...
            "methods": ["pay_invoice", "get_balance", "make_invoice", "lookup_invoice", "list_transactions", "make_offer", "enable_offer", "disable_offer", "list_offers", "get_offer_info", "get_info"], // list of supported methods for this connection
