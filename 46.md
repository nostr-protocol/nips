...
The signer scans the QR code and sends a `connect` message to the client in the specified relays using the request event format.
...
Request events sent by the client to the remote signer have the following format:
...
And reply events the remote signer sends to the client have the following format:
...
- **nip04_encrypt**
  - params: [`third-party-pubkey-hex`, `plaintext`]
  - result: `nip04-ciphertext`
- **nip04_decrypt**
  - params: [`third-party-pubkey-hex`, `nip04-ciphertext`]
  - result: `plaintext`
- **nip44_get_key**
  - params: [`third-party-pubkey-hex`]
  - result: `nip44-conversation-key-hex`
- **nip44_encrypt**
  - params: [`third-party-pubkey-hex`, `plaintext`]
  - result: `nip44-ciphertext`
- **nip44_decrypt**
  - params: [`third-party-pubkey-hex`, `nip44-ciphertext`]
  - result: `plaintext`
- **ping**
  - params: []
  - result: `"pong"`
