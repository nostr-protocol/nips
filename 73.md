...
Additional podcast `k` tags SHOULD be added to reference the [medium](https://github.com/Podcastindex-org/podcast-namespace/blob/main/docs/tags/medium.md) of the RSS feeds, and allow querying of notes related to specific RSS mediums such as music:
