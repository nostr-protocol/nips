...
- **Nostr Silent Payments (NSP)** (trbouma) — txid hint via encrypted messaging,
  Esplora-based local verification.
  [github.com/trbouma/openetr](https://github.com/trbouma/openetr)
