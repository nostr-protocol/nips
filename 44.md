...
- Cryptographic methods
  ...
  - Note: When using `bitcoin-core/secp256k1` lib the correct function to use is `secp256k1_ec_pubkey_tweak_mul`,
    not `secp256k1_ecdh`. The `secp256k1_ecdh` function includes additional hashing.
- Operators
