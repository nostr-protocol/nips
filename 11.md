...
```json
{
  ...
  "privacy-policy": <a link to a text file describing the relay's privacy policy>,
  "terms-of-service": <a link to a text file describing the relay's term of service>,
