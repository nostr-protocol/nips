...
Internet identifiers follow [RFC-5322](https://datatracker.ietf.org/doc/html/rfc5322#section-3.4.1) with the exception that names MUST only use characters `a-z0-9-_.`.
