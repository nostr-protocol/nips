...
An event with kind `30030` is defined as a parameterized replaceable list event for categorizing custom emojis. The 'd' parameter for this event holds the category name of the list. The tags included in these lists MUST follow the format of 'emoji' tags as defined in [NIP-30 - Custom Emoji](30.md) or 'a' tags including kind `30030` as defined in [NIP-33 - Parameterized Replaceable Events](33.md).
