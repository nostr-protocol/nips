...
| group Channels     | 10010 | [NIP-29a](29a.md) Channels the group has                      | `"channel"` ([NIP-29a](29a.md) group id + channel id + relay URL + optional channel name), `"r"` for each relay in use |
