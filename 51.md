...
| Indexer relays    | 10086 | Where to download/send kinds 0 and 10002 (e.g. purplepag.es)| `"relay"` (relay URLs)                                                                              |
| Proxy relays      | 10087 | Proxy/aggregator relays load from (e.g., filter.nostr.wine) | `"relay"` (relay URLs)                                                                              |
| Broadcast relays  | 10088 | Relays to send events to (e.g. sendit.nosflare.com)         | `"relay"` (relay URLs)                                                                              |
