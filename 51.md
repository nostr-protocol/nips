...
| Indexer relays    | 10086 | Preferred indexer (0 and 10002) relays (e.g. purplepag.es)  | `"relay"` (relay URLs)                                                                              |
| Proxy relays      | 10087 | Proxy/agreggator relays load from (e.g. filter.nostr.wine)  | `"relay"` (relay URLs)                                                                              |
| Broadcast relays  | 10088 | Broadcast relays to send events (e.g. sendit.nosflare.com)  | `"relay"` (relay URLs)                                                                              |
| Trusted relays    | 10089 | Trusted relays that can see the user's IP                   | `"relay"` (relay URLs)                                                                              |
