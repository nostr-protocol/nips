...
| Corny Chat Slide Set | 30388 | user-defined ordered list of captioned image urls exported from an audio space room | `"r"` (image URLs) |
...
| Corny Chat Link Set | 31388 | user-defined ordered list of captioned hyperlinks exported from an audio space room | `"r"` (image URLs) |
