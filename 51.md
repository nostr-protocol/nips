...
| Slide Set | 30388 | user-defined ordered list of captioned image urls | `"r"` (image URLs) |
...
| Link Set | 31388 | user-defined ordered list of captioned hyperlinks | `"r"` (web page URLs) |
