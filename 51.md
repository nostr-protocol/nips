...
| Places                | 30515 | Set of Places of interest or business locations owned by user ("Travel", "Favorite Restaurants", "Business Locations" etc.) | `"a"` (kind:37515 (see [NIP-XX](XX.md)))                                                                                        |
