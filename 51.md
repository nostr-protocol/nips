...
| File metadata sets | 30063 | groups of related files (e.g. artifacts in a software release)   | `"e"` (kind:1063 [file metadata](94.md) events), `"i"` (identifier, such as app ID), `"version"` (version, optional)  |
...
### A _file metadata set_ of a software release
...
```json
{
  ...
  "tags": [
    ["d", "ak8dy3v7"],
    ["i", "com.example.app"], // App identifier, reverse domain notation
    ["version", "0.0.1"],
    ["title", "Example App"],
