...
ratio of positive versus negative labels may instead be displayed to show the
level of agreement for a label, or used to dynamically adjust the label's threshold
for legitimacy, creating a form of community-driven moderation.
