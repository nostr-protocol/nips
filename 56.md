...
Clients may choose to ignore negative labels, it depends on the use case. When
put to use, the ratio of positive versus negative labels may be displayed to show
the level of agreement for a label, or used to dynamically adjust the label's threshold,
