...
Labels with negative affirmative markers may be used to display the ratio
of "consensus" for a label, or to dynamically adjust the threshold for a label,
creating a sort of community moderation.
