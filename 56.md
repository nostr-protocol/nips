...
- `"content"` - Labeling the content
- `"image"` - Labeling the image
- `"event"` - Labeling the event
...
> This scheme is deprecated because it limited reports to one of five types
