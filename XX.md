...
Anyone may join a public quorum by submitting `event:yyy`. For a private quorum, this request must be approved by the quorum in a similar fashion as the moderated community event `event:4550`.
