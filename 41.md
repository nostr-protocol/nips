...
Clients MAY surface `kind 361` migration events for people relevant to a given user, along with [NIP 22](./22.md) comments, [NIP 56](./56.md) reports, [NIP 25](./25.md) reactions, etc. This additional context MAY be used to help users decide whether to follow the migration or ignore it.
