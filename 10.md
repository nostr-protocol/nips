...
All reply events must also add a capital letter `E` tag, without marker, set to the id of the event they are replying too. This tag
enables lazy loading of direct replies to an event. For example: `["E", <event-id>, <relay-url>]`
