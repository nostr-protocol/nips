...
### `nostr.req_add_kind(req: i32, kind: u32) -> void`
...
### `nostr.req_set_limit(req: i32, limit: u32) -> void`

Sets the `"limit"` attribute of the filter.

### `nostr.req_set_since(req: i32, timestamp: u32) -> void`

Sets the `"since"` attribute of the filter.

### `nostr.req_set_until(req: i32, timestamp: u32) -> void`
...
### `nostr.event_get_kind(event_handle: i32) -> u32`

Returns the kind integer directly.

### `nostr.event_get_created_at(event_handle: i32) -> u32`
...
### `nostr.event_get_tag_count(event_handle: i32) -> u32`
