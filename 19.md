...
- `0`: `special`
  - depends on the bech32 prefix:
    ...
    - for `nchannel` it will be the 32 bytes of the `kind 40` event id
- `1`: `relay`
  - for `nprofile`, `nevent`, `naddr` and `nchannel`, a relay in which the entity (profile or event) is more likely to be found, encoded as ascii
...
- `nchannel1qqsztewgyfe6yuwtr2zq6qrq8ydqhayktjh7kq5at264x595rz2nlwcpz3mhxue69uhhyetvv9ujuerpd46hxtnfducdjqp3` should decode into a channel with the following TLV items:
  - kind 40 event id: `25e5c82273a271cb1a840d0060391a0bf4965cafeb029d5ab55350b418953fbb`
