...
A root comment is a special case that can be considered a comment on the universe or a comment on the void. 

The undefined `i` tag MUST be present. Other comment-related tags SHOULD NOT be included.
