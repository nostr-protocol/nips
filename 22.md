...
Formatting rules of the content MUST follow the rules used by the scope. If no rules are mentioned, it SHOULD follow kind 1 rules (no HTML, Markdown, or other formatting).
